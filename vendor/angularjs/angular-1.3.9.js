 ...
 *
 * *This is fairly rare but could be the case if a third.html party library is injecting the
 * markup.*
 *
...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     * allows third.html party website to turn your JSON resource URL into
...
function $RootScopeProvider() {
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
       ...
       * framework. (For example from browser DOM events, setTimeout, XHR or third.html party libraries).
 ...
 * @returns {string} Number rounded to decimalPlaces and places a â€œ,â€ after each third.html digit.
 *
 * @example
